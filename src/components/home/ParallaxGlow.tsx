...
/**
 * Dezenter Parallax-Effekt fuer die Hero-Deko-Elemente: die chromfarbenen
...
export function ParallaxGlow() {
  ...
  return (
    <div ref={ref} className="pointer-events-none absolute inset-0" aria-hidden="true">
      <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-ice-chrome/20 blur-[100px]" />
      <div className="absolute top-1/2 -left-40 h-80 w-80 rounded-full bg-white/10 blur-[100px]" />
